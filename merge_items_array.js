const items = { 
	...
	flowers: { type: "flowers", maxLevel: 10, set: {
			...
			2: { level:  2, pic: 'image/items/flowers/flower_2_level.png' },
			3: { level:  3, pic: 'image/items/flowers/flower_3_level.png' },
			4: { level:  4, pic: 'image/items/flowers/flower_4_level.png' },
