const items = { 
	...
	itemsForShop: {
		chest: { pic: 'chest', type: ['chestFlowers', 'chestWater', 'chestHills'], level: 1 },
		eggs: { pic: 'eggs', type: ['eggs'], level: 0}
	},

	eggs: { type: "eggs", maxLevel: null, set: {
			0: { blackDragon: { pic: 'image/items/eggs/blackDragon_0_level.png', countPrice: 50, resource: 'gold' },
			     redDragon:   { pic: 'image/items/eggs/redDragon_0_level.png', countPrice: 50, resource: 'gold' },
			     hillsDragon: { pic: '(h)', countPrice: 10, resource: 'crystal' },
			    },
			},
	},
	
	nest: { type: "nest", maxLevel: null, set: {
			0:  { pic: '<___>', giftFromClick: { type: 'eggs', minEggs: 3, maxEggs: 7 } } }, //не реализована по клику - яйца, после исчезает
	},

	chestFlowers: {type: "chestFlowers", maxLevel: 2, set: { //сундук 
			1:  { level:  1, pic:  "chF1", countPrice: 100, resource: 'wood',
						setFromClickOnItemForOneTime: { count: 5, 
							set: [
								{ type: 'flowers', level: 1 },
								{ type: 'flowers', level: 2 },
								{ type: 'trees', level: 0 },
								{ type: 'trees', level: 1 },
								{ type: 'fruit', level: 1 }
							],
			...
			2:  { level:  2, pic:  "chF2" , 
						setFromClickOnItemForOneTime: { count: 7, 
							set: [
								{ type: 'flowers', level: 2 },
								{ type: 'flowers', level: 3 },
								{ type: 'trees', level: 1 },
								{ type: 'trees', level: 2 },
								{ type: 'fruit', level: 1 },
								{ type: 'fruit', level: 2 }
	...
	chestWater: {type: "chestWater", maxLevel: 2, set: { //сундук 
			1:  { level:  1, pic:  "chW1", countPrice: 100, resource: 'wood',
						setFromClickOnItemForOneTime:{ count: 5,
							set:[
								{ type: 'water', level: 0 },
								{ type: 'water', level: 1 },
								{ type: 'water', level: 2 },
								{ type: 'mushrooms', level: 1 },
								{ type: 'reed', level: 1 }
							],
						},
					},
	...
	chestHills: {type: "chestHills", maxLevel: 2, set: { //сундук 
			1:  { level:  1, pic:  "chH1", countPrice: 100, resource: 'wood',
						setFromClickOnItemForOneTime: { count: 5,
							set:[
								{ type: 'hills', level: 1 },
								{ type: 'hills', level: 2 },
								{ type: 'gardenBed', level: 1 },
								{ type: 'countryHouse', level: 1 },
								{ type: 'hazel', level: 0 }
							] 
						},
					},
			2:  { level:  2, pic:  "chH2", 
						setFromClickOnItemForOneTime: { count: 7, 
							set: [
								{ type: 'hills', level: 2 },
								{ type: 'hills', level: 3 },
								{ type: 'gardenBed', level: 2 },
								{ type: 'gardenBed', level: 3 },
								{ type: 'countryHouse', level: 2 },
								{ type: 'hazel', level: 1 }
							] 
						}, 
					},
	...
	wood: { type: "wood", maxLevel: 10, set: { //древесина пока ничего на нее не купить
			 1: {level:  1, pic:  "wd1", price:  1 },
			 2: {level:  2, pic:  "wd2", price:  5 },
			 3: {level:  3, pic:  "wd3", price:  9 },
			 4: {level:  4, pic:  "wd4", price: 14 },
			 5: {level:  5, pic:  "wd5", price: 18 },
			 6: {level:  6, pic:  "wd6", price: 23 },
			 7: {level:  7, pic:  "wd7", price: 27 },
			 8: {level:  8, pic:  "wd8", price: 32 },
			 9: {level:  9, pic:  "wd9", price: 36 },
			10: {level: 10, pic: "wd10", price: 41 },
			},
	},
	...
	hills: { type: "hills", maxLevel: 10, set: { //холмы
			...
			10: {level: 10, pic: 'image/items/hills/hill_10_level.png',
					...
					setFromClickOnItem: { count: 10, leaveOnBoard: true,// по клику каждый раз что-то из этого выпадает:
						start: [ 
							//{ type: "nest", breed: 'hillsDragon', count: 1 },
							{ type: "eggs", level: 0, breed: 'hillsDragon' },
							{ type: "mine", level: 1 },							
						],
						end: [ 
							{ type: 'hazel', level: 1 },
	...
	mine: { type: "mine", maxLevel: 5, set: { //шахта
			 1: {level:  1, pic:  "mn1", 
					giftCollect: { type: 'fossil', level: 1 }, 
					giftCollectUniq: { type: "crystal", level: 1, breed: 'hillsDragon' }, //конкретный дракон собирает
			    },
			 2: {level:  2, pic:  "mn2", 
					giftCollect: { type: 'fossil', level: 1 }, 
					giftCollectUniq: { type: "crystal", level: 1, breed: 'hillsDragon' }, 
			    },
			 3: {level:  3, pic:  "mn3", 
					giftCollect: { type: 'fossil', level: 2 }, 
					giftCollectUniq: { type: "crystal", level: 2, breed: 'hillsDragon' }, 
		    	    },
			 4: {level:  4, pic:  "mn4", 
					giftCollect: { type: 'fossil', level: 2 }, 
					giftCollectUniq: { type: "crystal", level: 2, breed: 'hillsDragon' }, 
			 ...
			 5: {level:  5, pic:  "mn5",
 					giftCollect: { type: 'fossil', level: 3 }, 
					giftCollectUniq: { type: "crystal", level: 3, breed: 'hillsDragon' }, 
					setFromClickOnItem: { count: 7, leaveOnBoard: true,
						start: [
							{type: "crystal", level: 2},
						],
						end: [
							{type: "crystal", level: 1},
						],
					},
			    },
			},
	...
	crystal: { type: "crystal", maxLevel: 3, set: {//кристалы пока ничего на них не купить
			 1: {level:  1, pic:  "cr1", price:  1 },
			 2: {level:  2, pic:  "cr2", price:  4 },
			 3: {level:  3, pic:  "cr3", price: 16 },
		},
	},
	...
	stone: { type: "stone", maxLevel: 10, set: { //хочу камни медитации с сакурой
			 1: {level:  1, pic:  "st1", giftCollect: { type: 'stone', level: 1 }, },
			 2: {level:  2, pic:  "st2", giftCollect: { type: 'stone', level: 1 }, },
			 3: {level:  3, pic:  "st3", giftCollect: { type: 'stone', level: 1 }, },
			 4: {level:  4, pic:  "st4", giftCollect: { type: 'stone', level: 1 }, },
			 5: {level:  5, pic:  "st5", giftCollect: { type: 'stone', level: 1 }, },
			 6: {level:  6, pic:  "st6", giftCollect: { type: 'stone', level: 1 }, },
			 7: {level:  7, pic:  "st7", giftCollect: { type: 'stone', level: 1 }, },
			 8: {level:  8, pic:  "st8", giftCollect: { type: 'stone', level: 1 }, },
			 9: {level:  9, pic:  "st9", giftCollect: { type: 'stone', level: 1 }, },
			10: {level: 10, pic: "st10", giftCollect: { type: 'stone', level: 1 }, }, // не реализовано летающие предметы после сферы - золото
			},
	},
	...
	countryHouse: { type: "countryHouse", maxLevel: 5, set: { //дачный домик
			 ...
			 4: {level:  4, pic:  "ch4" },
			 5: {level:  5, pic:  "ch5",
					setFromItemForOneTime: {type: "grape", level: 1, count: 7, time: 1 * 60 * 1000},
					setFromClickOnItem: { count: 5, leaveOnBoard: true,
						start: [
							{type: "gardenBed", level: 3},
							{type: "gardenBed", level: 2},
						],
	...
	grape: {type: "grape", maxLevel: 10, set: {
			 0: {level:  0, pic:  "gr0" },
			 1: {level:  1, pic:  "gr1" },
			 2: {level:  2, pic:  "gr2" },
			 3: {level:  3, pic:  "gr3" },
			 ...
			 8: {level:  8, pic:  "gr8" },
			 9: {level:  9, pic:  "gr9" },
			10: {level: 10, pic: "gr10" },
			},
	},
	gardenBed: {type: "gardenBed", maxLevel: 6, set: {
			 1: {level:  1, pic:  "gB1" },
			 2: {level:  2, pic:  "gB2", giftOnItem: {type: 'vegetable', level: 1, time: 1 * 60 * 1000, count: 4}, }, //редиска
			 3: {level:  3, pic:  "gB3", giftOnItem: {type: 'vegetable', level: 2, time: 1 * 60 * 1000, count: 4}, }, //морковка
			 4: {level:  4, pic:  "gB4", giftOnItem: {type: 'vegetable', level: 3, time: 1 * 60 * 1000, count: 4}, }, //баклажаны
			 5: {level:  5, pic:  "gB5", giftOnItem: {type: 'vegetable', level: 4, time: 1 * 60 * 1000, count: 4}, }, //перцы
			 6: {level:  6, pic:  "gB6" }, //много разных яиц 
			},
	},

	vegetable: {type: "vegetable", maxLevel: null, fullCollect: true, set: {
			 1: {level:  1, pic:  "veg1", 
	...
	gold: {type: "gold", maxLevel: 10, set: {
			1:  {level:  1, pic:  'image/items/gold/gold_1_level.png', price:  1 },
			2:  {level:  2, pic:  'image/items/gold/gold_2_level.png', price:  5 },
			3:  {level:  3, pic:  'image/items/gold/gold_3_level.png', price:  9 },
			4:  {level:  4, pic:  'image/items/gold/gold_4_level.png', price: 14 },
			5:  {level:  5, pic:  'image/items/gold/gold_5_level.png', price: 18 },
			6:  {level:  6, pic:  'image/items/gold/gold_6_level.png', price: 23 },
			7:  {level:  7, pic:  'image/items/gold/gold_7_level.png', price: 27 },
			8:  {level:  8, pic:  'image/items/gold/gold_8_level.png', price: 32 },
			9:  {level:  9, pic:  'image/items/gold/gold_9_level.png', price: 36 },
			10: {level: 10, pic: 'image/items/gold/gold_10_level.png', price: 41 },
			},
	},
}